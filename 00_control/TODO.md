...
- [~] Martingale properties, stopping, inequalities, convergence, and backwards martingales; `martingales/Introduction.html` is release-ready and `martingales/Properties.html` is the next exact unit.
