...
- [~] Martingale properties, stopping, inequalities, convergence, and backwards martingales; `Introduction` and `Properties` are public, and `martingales/Stop.html` is translated locally pending integration.
